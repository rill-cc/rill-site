...
export default function Meta() {
	return (
		<Head>
	  	...
	  	<meta name="description" content="An open platform that helps interconnect environmental events and track updates." />
		  ...
		  <meta property="og:description" content="An open platform that helps interconnect environmental events and track updates." />
