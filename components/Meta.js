...
export const Meta = () => {
	return (
    	...
    	<meta name="description" content="Open platform that helps interconnect environmental events and track updates." />
		  ...
		  <meta property="og:description" content="Open platform that helps interconnect environmental events and track updates." />
